...
public class ThreeNoteAuton extends SequentialCommandGroup {
  /** Creates a new ThreeNoteAuton. */
  public ThreeNoteAuton(Shooter shooter, Indexer indexer, Pivot pivot, Intake intake, Limelight limelight, PathPlannerPath traj1, PathPlannerPath traj2, PathPlannerPath traj3, PathPlannerPath traj4) {
